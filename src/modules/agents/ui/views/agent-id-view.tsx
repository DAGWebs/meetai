...
export const AgentIdView = ({ agentId }: Props) => {
  ...
  const [RemoveConfirmation, confirmRemove] = useConfirm(
    "Are you sure?",
    `The following action will remove ${data.meetingCount} associalted  ${
  ...
  return (
    <>
      ...
      <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-4">
        ...
        />
        <div className="bg-white dark:bg-gray-900 rounded-lg boarder">
          <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
            <div className="flex litems-center gap-x-3">
              <GeneratedAvatar
                seed={data.name}
            ...
            >
              <VideoIcon className="text-green-800 dark:text-green-500" />
              <span>
                {data.meetingCount}{" "}
                {data.meetingCount === 1 ? "Meeting" : "Meetings"}
              </span>
